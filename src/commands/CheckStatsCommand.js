    ...
    static async showModelComparisonStats(message) {
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription([
                    'Compare how GPT and Claude perform head-to-head in UFC predictions.', // Updated description
            ...
            stats.forEach(stat => {
                const modelName = stat.model_used === 'gpt' ? 'GPT' : 'Claude'; // Updated display name
